...
export default function Nav({ isActive, setIsActive }: NavProps) {
  ...
  return (
    <>
      ...
      <div
        ref={container}
        className="fixed top-0 -right-25 md:-right-26 h-screen w-full md:w-[650px] bg-primary backdrop-blur-lg shadow-lg text-white z-30 translate-x-full"
      >
        ...
        >
          ...
          <div className="absolute top-8 left-10 md:right-20 z-36">
            <div className="relative">
              ...
              {/* Dropdown */}
              <div
                className={`absolute top-full left-0 mt-2 bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden border border-white/20 transition-all duration-300 ${
                  langMenuOpen
              ...
              >
                {languages.map((lang) => (
                  <button
                    ...
                    className={`w-full px-5 py-3 text-left text-sm trispace-font tracking-wide transition-all duration-200 hover:bg-white/10 flex items-center justify-between gap-4 ${
                      locale === lang.code ? "bg-white/15" : ""
                    }`}
                  >
          ...
          <div className="flex flex-col gap-4 mt-24">
            {/* Section Label */}
            <div className="mb-8">
              <p className="text-white/40 uppercase text-[10px] tracking-[0.3em] trispace-font">
                {t2("navigation")}
              </p>
